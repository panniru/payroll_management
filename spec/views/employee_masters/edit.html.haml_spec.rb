...
RSpec.describe "employee_masters/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit employee_master form" do
    render

    assert_select "form[action=?][method=?]", employee_master_path(@employee_master), "post" do
