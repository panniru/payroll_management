$(function() {
    ...
    var iconTopPadding1 = 0-($('.datepicker').first().height()+10)
    ...
    $(".input-icon1").css({'background-color': 'none', 'border': 'none', 'background' : 'none', 'position': 'inline', 'top': iconTopPadding, 'left': '100%', 'position': 'relative'})
